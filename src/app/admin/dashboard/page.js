      ...
      <div className="py-6">
        ...
        <div className="mt-8 bg-white rounded-xl shadow-md p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Link href="/admin/news" className="flex items-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
              ...
              <div className="ml-4">
                <h3 className="font-medium text-gray-900">News Management</h3>
